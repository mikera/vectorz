...
public class TestBlockHouseHolder {
    ...
    public void decomposeQR_block_col() {
        ...
        double gammas[] = new double[A.columnCount()];
    ...
    public void innerProdCol() {
        ...
        for( int colBlock = 0; colBlock < r*2; colBlock+=r) {
            ...
            int widthA = Math.min(r,A.columnCount() - (colA-colA%r));
            int widthB = Math.min(r,A.columnCount() - (colB-colB%r));

            DenseMatrix64F v0 = CommonOps.extract(A,row,A.rowCount(),colA,colA+1);
            DenseMatrix64F v1 = CommonOps.extract(A,row,A.rowCount(),colB,colB+1);
            ...
            D1Submatrix64F subAb = new D1Submatrix64F(Ab,row,A.rowCount(),colBlock,A.columnCount());
    ...
    public void innerProdRow() {
        ...
        for( int rowBlock = 0; rowBlock < r*2; rowBlock+=r) {
            ...
            DenseMatrix64F v0 = CommonOps.extract(A,rowBlock+rowA,rowBlock+rowA+1,0,A.columnCount());
            DenseMatrix64F v1 = CommonOps.extract(A,rowBlock+rowB,rowBlock+rowB+1,0,A.columnCount());
            ...
            D1Submatrix64F subAb = new D1Submatrix64F(Ab,rowBlock,A.rowCount(),0,A.columnCount());
    ...
    public void divideElementsCol() {
        ...
        for( int i = col+1; i < A.rowCount(); i++ ) {
    ...
    public void scale_row() {
        ...
        // check the rest
        for( int i = row+2; i < A.columnCount(); i++ ) {
...
//            System.out.println("width "+width);
    ...
    public void computeTauAndDivideRow() {
        ...
        // manual alg
        double expected = 0;
        for( int j = colStart; j < A.columnCount(); j++ ) {
    ...
    public void computeW_Column() {
        ...
        BlockMatrix64F Ab = BlockMatrixOps.convert(A.getMatrix(),r);
        BlockMatrix64F Wb = new BlockMatrix64F(Ab.rowCount(),Ab.columnCount(),r);
