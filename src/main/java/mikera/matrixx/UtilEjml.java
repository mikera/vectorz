...
/**
 * Various functions that are useful but don't have a clear location that they
 * belong in.
 * 
 * @author Peter Abeles
 */
public class UtilEjml {
   ...
   */
  public static Matrix parseMatrix(String s, int numColumns) {
    ...
    Matrix ret = Matrix.create(numRows, numColumns);
