...
/**
 * <p>
 * Base class for reading CSV formatted files. CSV stands for column-space-value
 * where text strings are separated by a space character. The values are
 * typically stored in a human readable format. The encoded text for a single
 * variable is referred to as a word.
 * </p>
 * 
 * <p>
 * Comments are allowed and identified by starting a line with the comment
 * character. The comment character is user configurable. By default there is no
 * comment character.
 * </p>
 * 
 * @author Peter Abeles
...
public class ReadCsv {
  ...
  /**
   * Sets the comment character. All lines that start with this character will
   * be ignored.
   * 
   ...
   * 
   * @return List of valid words on the line. null if the end of the file has
   *         been reached.
