...
public class EigenOps {
    ...
    public static Eigenpair computeEigenVector( DenseMatrix64F A , double eigenvalue )
    {
        ...
        DenseMatrix64F M = new DenseMatrix64F(A.rowCount(),A.columnCount());

        DenseMatrix64F x = new DenseMatrix64F(A.rowCount(),1);
        DenseMatrix64F b = new DenseMatrix64F(A.rowCount(),1);
...
//        eigenvalue -= eigenvalue*UtilEjml.EPS*10;
        ...
        LinearSolver<DenseMatrix64F> solver = LinearSolverFactory.linear(M.rowCount());
