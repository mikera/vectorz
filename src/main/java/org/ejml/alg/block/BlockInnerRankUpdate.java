...
public class BlockInnerRankUpdate {
                                    ...
                                    D1Submatrix64F A , D1Submatrix64F B )
    {
        ...
        for( int i = B.col0; i < B.col1; i += blockLength ) {
            ...
            int indexB_i = B.row0*B.original.columnCount() + i*heightB;
            ...
            for( int j = B.col0; j < B.col1; j += blockLength ) {
                ...
                int indexA = rowA * A.original.columnCount() + (j-B.col0+A.col0)*heightA;
                int indexB_j = B.row0*B.original.columnCount() + j*heightB;
                                         ...
                                         D1Submatrix64F A , D1Submatrix64F B )
    {
        ...
        for( int i = B.row0; i < B.row1; i += blockLength ) {
            ...
            int indexB_i = i*B.original.columnCount() + heightB_i*B.col0;
            ...
            for( int j = B.row0; j <= i; j += blockLength ) {
                ...
                int indexA = rowA * A.original.columnCount() + (j-B.row0+A.col0)*heightA;
                int indexB_j = j*B.original.columnCount() + widthB_j*B.col0;
